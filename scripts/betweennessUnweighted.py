...
results_dir = DATA_DIR / "results/removal_runs_betweenness_unweighted_node_BE"
results_dir.mkdir(parents=True, exist_ok=True)

attributes = load_gtfs(str(DATA_DIR / "sqlite/belgium.sqlite"))
L_graph = load_graph(DATA_DIR / "pkl/belgium_routesCleaned.pkl")
log_path = results_dir / "removal_betweenness_unweighted_BE.log"
...
with open(log_path, "w") as log_file:
    ...
    try:
        ...
        output_filename = f"betweenness_unweighted_removal_seed{seed}_nodes{num_nodes_total}.csv"
