    ...
    try:
        ...
        original_efficiency, efficiencies, pct_remaining, removed_nodes, removal_times = \
            simulate_fixed_node_removal_efficiency(
                ...
                pct_to_remove=100,
                removal_type='node',
                method='targeted_least',
                seed=seed
            )

        output_filename = f"targeted_least_removal_seed{seed}_nodes{num_nodes_total}.csv"
